...
class ProjectsPropertiesModel {
  int? status;
  String? message;
  List<Data>? data;

  ProjectsPropertiesModel({this.status, this.message, this.data});

  ProjectsPropertiesModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    projectProfile = json['project_profile'];
    ...
    if (json['Project_amenities'] != null) {
      projectAmenities = <Amenities>[];
      json['Project_amenities'].forEach((v) {
        projectAmenities!.add(Amenities.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['project_profile'] = projectProfile;
    ...
    if (projectAmenities != null) {
      data['Project_amenities'] =
          projectAmenities!.map((v) => v.toJson()).toList();
    }
